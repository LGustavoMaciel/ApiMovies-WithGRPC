...
func main() {
	...
	//  runCreateMovie(client, "3","24325645", "Spiderman Spiderverse",
	// 	"Stan", "Lee")
...
func runCreateMovie(client pb.MovieClient, movieid string, isbn string, title string, firstname string, lastname string) {
